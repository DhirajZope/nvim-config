...
map("n", "<C-z>", ":undo<CR>") -- prevent force-closing with Ctrl+z
...
map("n", "<leader>zz", ":source %<CR>", { desc = "Source current file." })
...
map("n", "<leader>gtt", ":Gitsigns toggle_current_line_blame<CR>", { desc = "Toggle current line blame." })
...
-- finecmdline
map("n", "<leader>oo", "<cmd>FineCmdline<CR>", { desc = "CMD enter command mode" })
-- mdpreview
